...
export const ResolutionNode = memo(({ data }: { data: { label: string; resolution: string } }) => {
  return (
    <div className="rounded-lg border border-border bg-surface-200 px-3 py-2 min-w-[120px]">
